...
area2=[(101,363),(84,420),(132,420),(143,363)]
...
#        print(row)
    ...
    if a2==1:
        ...
        cv2.putText(frame,str('2'),(124,435),cv2.FONT_HERSHEY_COMPLEX,0.5,(0,0,255),1)
    else:
        cv2.polylines(frame,[np.array(area2,np.int32)],True,(0,255,0),2)
        cv2.putText(frame,str('2'),(124,435),cv2.FONT_HERSHEY_COMPLEX,0.5,(255,255,255),1)
